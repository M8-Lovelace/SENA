...
<!-- Ambos planes se les carga 10% del costoProducto si la persona
...
<div>
  ...
  <button @click="verificar()">Verificar</button>
  <button @click="limpiarCampos()" id="limpiarCampos">Limpiar</button>
</div>
</template>
...
export default {
  setup() {
    ...
    // en el template
    return { 
      n, rta, verificar, limpiarCampos, color
    };
  },
}
